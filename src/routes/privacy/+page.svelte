<script lang="ts">
  ...
  const title = 'НИЦ СЭ • Политика конфиденциальности';
  const description =
    'Политика конфиденциальности персональных данных предприятия АО НИЦ «Строительная экспертиза»';
</script>
...
<article
  ...
  <div class="content readable pb-8 text-slate-700 dark:text-slate-300">
    <div>
      ...
      <b class="whitespace-nowrap">АО&nbsp;НИЦ «Строительная&nbsp;экспертиза»</b> (далее &mdash;
      Сайт), расположенный на доменном имени <code>stroyexp.info</code>, может получить
          ...
          <div>
            ...
            <div class="list">
              <div>
                ...
                сотрудники на управления сайтом, действующие от имени
                <b>АО&nbsp;НИЦ «Строительная&nbsp;экспертиза»</b>, которые организуют и (или)
      ...
      <div class="contents">
        <div class="list">
          ...
          <div>
            ...
            <code>https://stroyexp.info/contacts</code>.
          </div>
          <div>
            Действующая Политика конфиденциальности размещена на странице по адресу
            <code>https://stroyexp.info/privacy</code>.
          </div>
        </div>
      </div>
    </div>
